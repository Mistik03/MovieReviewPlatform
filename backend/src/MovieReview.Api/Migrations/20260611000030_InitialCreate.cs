        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CharacterName = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    CastOrder = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CastMembers", x => new { x.TitleId, x.PersonId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_CastMembers_Titles_TitleId",
                        column: x => x.TitleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Rating_Score", "\"Score\" BETWEEN 1 AND 10");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Titles_Name_ReleaseYear_MediaType",
                table: "Titles",
                columns: new[] { "Name", "ReleaseYear", "MediaType" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Titles_TmdbId_MediaType",
                table: "Titles",
